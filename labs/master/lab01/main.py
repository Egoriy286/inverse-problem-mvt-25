...
OUTPUT_DIR = Path(__file__).resolve().parents[3] / "results" / "lab01"
...
fig1.savefig(OUTPUT_DIR / "p_recovery.png", dpi=150, bbox_inches="tight")
fig2.savefig(OUTPUT_DIR / "u_recovery.png", dpi=150, bbox_inches="tight")
fig3.savefig(OUTPUT_DIR / "error.png", dpi=150, bbox_inches="tight")
